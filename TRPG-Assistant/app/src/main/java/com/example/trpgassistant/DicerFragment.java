    ...
    generateButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            if (numberOfEdgesField.getText().toString().isEmpty()) {
              numberOfEdges = 0;
            } else {
              numberOfEdges = Integer.valueOf(numberOfEdgesField.getText().toString());
            }
            if (numberOfDicesField.getText().toString().isEmpty()) {
              numberOfDices = 1;
            } else {
              numberOfDices = Integer.valueOf(numberOfDicesField.getText().toString());
            }
            if (modifierField.getText().toString().isEmpty()) {
              modifier = 0;
            } else {
              modifier = Integer.valueOf(modifierField.getText().toString());
            }
            ...
            dicerLogAdapter.addDices(new Dice(numberOfEdges, numberOfDices, modifier));
